...
public class AppSGFCellUpdateBytesSTR extends TGS_SGWTFuncBase implements IsSerializable {
    ...
    public AppSGFCellUpdateBytesSTR() {
    }

    public AppSGFCellUpdateBytesSTR(TGS_LibTableDbSub dbCfg, TGS_LibRqlTbl table, long id,
    ...
    public String toString() {
        var sb = new StringBuilder(AppSGFCellUpdateBytesSTR.class.getSimpleName());
