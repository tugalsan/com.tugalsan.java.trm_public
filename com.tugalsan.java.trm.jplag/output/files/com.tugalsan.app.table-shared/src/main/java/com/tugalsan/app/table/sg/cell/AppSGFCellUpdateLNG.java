...
public class AppSGFCellUpdateLNG extends TGS_SGWTFuncBase implements IsSerializable {
    ...
    public AppSGFCellUpdateLNG() {
    }

    public AppSGFCellUpdateLNG(TGS_LibTableDbSub dbCfg, TGS_LibRqlTbl table, long id, String columnname, long value) {
        input_dbCfg = dbCfg;
        input_table = table;
        input_id = id;
    ...
    public void setInput_value(Long input_value) {
    ...
    public String toString() {
        var sb = new StringBuilder(AppSGFCellUpdateLNG.class.getSimpleName());
